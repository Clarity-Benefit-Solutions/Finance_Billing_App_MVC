...
namespace FinaceBilling.Controllers
{
    public class QuickbookController : Controller
    {
        ...
        public QuickbookController(IHostingEnvironment env, IConfiguration config, IErrorLogService iErrorLogService, Finance_BillingContext db, IFileNameService iFileNameService)
        {
            _env = env;
            _db = db;
            _config = config;
